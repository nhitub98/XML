<html>   <body>
<form method="POST" action="capnhatkhachhang.php">Ma khach hang <input type="text" name="ID"></br>
Ten khach hang <input type="text" name="Tenkh"></br>
Tuoi <input type="text" name="Tuoi"></br>Dien thoai <input type="text" name="Dienthoai"></br>
<input type="submit" name="Add" value="Them"><input type="submit" name="Update" value="Sua">
<input type="submit" name="Delete" value="Xoa"><input type="submit" name="Xem" value="Xem thong tin">
<input type="submit" name="Search" value="Tim khach hang co tuoi <=20"> </form>
<?php   
...
$rootTag->appendChild($infoTag); //Tạo nút cho cây
...
if(isset($_POST['Update'])){
  ...
  $root->load('khachhang.xml');
    $id=$_POST['ID']; 
     $tenkh=$_POST['Tenkh'];
  $tuoi=$_POST['Tuoi'];  
  $phone=$_POST['Dienthoai'];//tim den node goc
...
$root->save('khachhang.xml');}    //Nut xoa
...
$root->save('khachhang.xml');}//Nut tim kiem
